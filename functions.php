 ...
 * Register Blocks
 */
function wpdocs_create_blocks_init() {
 ...
 * Add video slider js
 */
function enqueue_video_slider_js() {
	wp_enqueue_script( 'jquery' );
	wp_enqueue_script( 'video-slider', get_template_directory_uri() . '/custom.js', array(), rand( 1, 10000 ), true );
}
